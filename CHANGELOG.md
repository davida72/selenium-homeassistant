...
### Changed
- **Box formatting** - Adjusted separator line to 53 equals signs for better fit with longer placeholder text

## [1.2.8] - 2025-11-12

### Fixed
- **Startup hanging fixed** - Removed all complex Supervisor API calls that were causing indefinite hangs
- **Simplified IP detection** - Now uses simple, fast hostname command with basic Docker IP filtering
- **Faster startup** - No more waiting for API timeouts, add-on starts immediately

## [1.2.7] - 2025-11-12

### Fixed
- **Add-on startup hanging** - Added 3-second timeouts to all curl commands to prevent indefinite hanging when Supervisor API is slow or unresponsive
